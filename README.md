...
- `modmailisfakenews`, rewrite planned
- `chessisfakenews`, rewrite planned
- `logisfakenews`, rewrite planned
- `modisfakenews`, rewrite planned
- `economyisfakenews`, rewrite planned
...
Rewrites will likely happen in the order of the list above, although that could change. They will happen as and when i have time, with no current timescale of when that will be
...
If you do find a security issue, email me at contact@lifn.me, or `@lifeisfakenews` on Discord
