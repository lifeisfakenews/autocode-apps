...
let audit = await lib.discord.guilds['@0.2.3'].auditLogs.list({guild_id: context.params.event.guild_id, action_type: 22, limit: 1});//Get audit log data
...
**Reason:** ${audit.audit_log_entries[0].reason}`,
      color: 0xE72020,
      author: {name: `User Banned`, icon_url: user.avatar_url},
