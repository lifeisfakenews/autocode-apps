...
let audit = await lib.discord.guilds['@0.2.3'].auditLogs.list({guild_id: context.params.event.guild_id, action_type: 11, limit: 1});//Get audit log data
...
**Permissions:** \n${permString}`,
      ...
      color: 0x0f94d7,
      author: {name: `Channel Updated`, icon_url: user.avatar_url},
