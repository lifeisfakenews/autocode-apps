...
let channel = await lib.discord.guilds['@0.1.0'].channels.create({
  ...
  topic: `Opened by: ${context.params.event.member.user.username}. Reason: Bot Suggestion.`,
...
let message = await lib.discord.channels['@0.2.0'].messages.create({
  ...
  content: `Ticket has been created for reason: Bot Suggestion`,
