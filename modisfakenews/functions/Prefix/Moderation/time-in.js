...
await lib.discord.guilds['@release'].members.timeout.destroy({user_id: target.user.id, guild_id});
await lib.discord.channels['@release'].messages.create({channel_id, content: `**${target.user.username}** has been timed in for ${reason}`});
...
<:reason:${emojis.reason}> | ${reason}`,
      ...
      author: {name: `${cNum} | Time In`, icon_url: target.avatar_url || 'https://cdn.discordapp.com/attachments/911294620439293993/965586325208195142/avatar.png'},
