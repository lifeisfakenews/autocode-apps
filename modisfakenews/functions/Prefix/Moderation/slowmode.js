...
await lib.discord.channels['@release'].update({channel_id, rate_limit_per_user: parseInt(num)});
await lib.discord.channels['@release'].messages.create({channel_id, content: `Slowmode has been set to **${num}** seconds for ${reason}`});
